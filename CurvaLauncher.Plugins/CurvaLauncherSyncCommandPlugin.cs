...
public abstract class CurvaLauncherSyncCommandPlugin : CurvaLauncherCommandPlugin
{
    protected CurvaLauncherSyncCommandPlugin(CurvaLauncherContext context) : base(context)
    {
    }
